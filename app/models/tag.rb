class Tag < ApplicationRecord
  ...
  def self.get_video_from_embed_task(url)
    ...
    if doc.css('title').text != "TikTok"
      ...
      @video_official_id = a.split('"id":"')[1].split('","')[0] unless js.split('"id":"')[1].nil?
      # @video_user_official_id = a.split('"userId":"')[1].split('","')[0]
      @video_interaction_count = a.split('"diggCount":')[1].split(',"')[0] unless js.split('"diggCount":')[1].nil?
      @video_share_count = a.split('"shareCount":')[1].split(',"')[0] unless js.split('"shareCount":')[1].nil?
      @video_comment_count = a.split('"commentCount":')[1].split(',"')[0] unless js.split('"commentCount":')[1].nil?
      ...
      @video_cover_url = a.split('"urlsOrigin":["')[1].split('"],"')[0] unless js.split('"urlsOrigin":["')[1].nil?
      ...
      @video_tags_title = a.split('"text":"')[1].split('","')[0].split('#').drop(1).map(&:strip!).compact! unless js.split('"text":"')[1].nil?
      @video_user_official_id = a.split('"secUid":"')[1].split('","')[0] unless js.split('"secUid":"')[1].nil?
      @video_user_nick_name = a.split('"nickName":"')[1].split('","')[0] unless js.split('"nickName":"')[1].nil?
      @video_user_cover = a.split('"avatarUriOrigin":["')[1].split('"],"')[0] unless js.split('"avatarUriOrigin":["')[1].nil?
