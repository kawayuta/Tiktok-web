...
class UserHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_history" do
    assert_difference('UserHistory.count') do
      post user_histories_url, params: { user_history: { user_nick_named: @user_history.user_nick_named, user_official_id: @user_history.user_official_id } }
    end
  ...
  test "should update user_history" do
    patch user_history_url(@user_history), params: { user_history: { user_nick_named: @user_history.user_nick_named, user_official_id: @user_history.user_official_id } }
